...
The resulting tibble contains the following columns:
  ...
  - n_words: The number of words in the scraped text
  - chunks: The text split into chunks
  - n_tokens: The number of tokens in each chunk
  - embeddings: The embeddings for each chunk of text
